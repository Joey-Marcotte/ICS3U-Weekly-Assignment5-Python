...
def main():
    ...
    while True:
        ...
        number = input("Enter a number to show the amount of +,-,0 numbers or \
'End' to display amounts: ")
        try:
            ...
            if number == "End":
                print("There is {0} positive numbers, {1} negative numbers, \
and {2} zeros".format(positive_numbers, negative_numbers, zeros))
                break
            else:
